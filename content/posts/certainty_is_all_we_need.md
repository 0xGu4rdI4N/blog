...
Well, so it seems, for many of the observable behavior of the universe, things have been deterministic because despite nature being wildly complex, at an aggregate level( *observable behaviour* ), many variables cancel out. for eg. 1. Countless forces on a falling object → but motion is a parabola
2. A pendulum
    ...
    But the observed behavior collapses to:
                <cent> $$ \theta''(t) + \frac{g}{L} \sin \theta = 0 $$ </cent>
...
<pink>this uncertainity stems out of our ignorance of the world and the underlying processes </pink>
