...
If you give some thought, we often associate probability with the frequentist view that it is the relative occurence of an event. So are we teaching our model to just 
