            ...
            <section className="relative z-10 pt-32 pb-20 px-6 max-w-5xl mx-auto">
                <div className="flex flex-col md:flex-row gap-16 items-start">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col gap-6">
                        <div className="aspect-square w-full rounded-2xl overflow-hidden border-2 shadow-2xl bg-white dark:bg-neutral-900 border-slate-200 dark:border-neutral-800">
                            <div className="w-full h-full flex flex-col items-center justify-center gap-4 text-slate-700 dark:text-neutral-700">
                        ...
                        <div className="flex justify-center gap-4">
                            {[{ Icon: Github }, { Icon: Linkedin }, { Icon: Mail }].map(({ Icon }, i) => (
                                <a key={i} href="#" className="p-3 rounded-full border bg-white dark:bg-neutral-900 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-neutral-800 hover:bg-emerald-500/20 hover:text-emerald-500 dark:hover:text-emerald-400 transition-all">
                                    <Icon size={18} />
                                </a>
                            ))}
                        </div>
                    ...
                    <div className="w-full md:w-2/3 pt-2">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-medium mb-6 backdrop-blur-sm bg-white/50 dark:bg-neutral-900/50 border-slate-200 dark:border-neutral-800 text-emerald-600 dark:text-emerald-400">
                        ...
                        <div className="space-y-12">
                            <div className="p-6 rounded-xl border bg-slate-50 dark:bg-neutral-900/30 border-slate-200 dark:border-neutral-800 relative overflow-hidden">
                                <div className="absolute top-0 left-0 w-1 h-full bg-violet-500"></div>
                                <h4 className="text-xl font-bold mb-3 flex items-center gap-2 text-violet-600 dark:text-violet-400">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-200">Research & Projects</h2>
                        </div>
                        <div className="flex flex-col gap-6">
                            {PUBLICATIONS.map((paper, i) => (
                                <div key={i} className="group relative p-6 rounded-2xl border transition-all duration-300 backdrop-blur-sm bg-white dark:bg-neutral-900/40 border-slate-200 dark:border-neutral-800 hover:bg-slate-50 dark:hover:bg-neutral-900/80">
                                    <h3 className="text-xl font-semibold mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-500 transition-colors text-slate-800 dark:text-slate-200">{paper.title}</h3>
                                    <p className="text-sm mb-3 font-medium text-violet-600 dark:text-violet-400">{paper.venue}</p>
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-200">Recent Writing</h2>
                        </div>
